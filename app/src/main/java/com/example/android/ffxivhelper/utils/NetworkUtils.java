package com.example.android.ffxivhelper.utils;
...
public class NetworkUtils {
    ...
    final static String API_KEY = "d323650dace1e133e3af04779857c27901553129761";
     ...
     *
     * @param xivapiSearchQuery The keyword that will be queried for.
     * @return The URL to use to query the GitHub.
     */
    public static URL buildUrl(String xivapiSearchQuery) {
